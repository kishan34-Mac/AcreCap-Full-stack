    ...
    <section className="section-padding bg-secondary/30">
      <div className="container-custom">
        ...
        <div className="mb-12 sm:mb-16">
          <div className="flex items-center justify-between gap-3 mb-6 sm:mb-8">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center">
                <Banknote className="w-6 h-6 text-primary-foreground" />
              </div>
              <h3 className="text-lg sm:text-2xl font-bold text-foreground">Loan Products</h3>
            </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 sm:gap-6">
            {loanServices.map((service, i) => (
              <Link
                key={i}
                to={service.href}
                className="glass-card-hover group p-5 sm:p-6"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="text-base sm:text-lg font-semibold text-foreground mb-1 group-hover:text-primary transition-colors">
                      {service.name}
                    </h4>
        ...
        <div>
          <div className="flex items-center justify-between gap-3 mb-6 sm:mb-8">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-ocean to-ocean/80 flex items-center justify-center">
                <Shield className="w-6 h-6 text-ocean-foreground" />
              </div>
              <h3 className="text-lg sm:text-2xl font-bold text-foreground">Insurance Products</h3>
            </div>
