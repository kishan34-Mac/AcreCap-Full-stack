...
DO $$ BEGIN
  -- Rename businessName to business_name if it exists (case sensitive)
  ...
  ELSIF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'submissions' AND column_name = 'businessname') THEN
    ALTER TABLE public.submissions RENAME COLUMN businessname TO business_name;
  END IF;
  ...
  ELSIF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'submissions' AND column_name = 'businesstype') THEN
    ALTER TABLE public.submissions RENAME COLUMN businesstype TO business_type;
  END IF;
  ...
  ELSIF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'submissions' AND column_name = 'annualturnover') THEN
    ALTER TABLE public.submissions RENAME COLUMN annualturnover TO annual_turnover;
  END IF;
  ...
  ELSIF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'submissions' AND column_name = 'yearsinbusiness') THEN
    ALTER TABLE public.submissions RENAME COLUMN yearsinbusiness TO years_in_business;
  END IF;
  ...
  ELSIF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'submissions' AND column_name = 'loanamount') THEN
    ALTER TABLE public.submissions RENAME COLUMN loanamount TO loan_amount;
  END IF;
  ...
  ELSIF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'submissions' AND column_name = 'loanpurpose') THEN
    ALTER TABLE public.submissions RENAME COLUMN loanpurpose TO loan_purpose;
  END IF;
  ...
  ELSIF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'submissions' AND column_name = 'pannumber') THEN
    ALTER TABLE public.submissions RENAME COLUMN pannumber TO pan_number;
  END IF;
  ...
  ELSIF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'submissions' AND column_name = 'gstnumber') THEN
    ALTER TABLE public.submissions RENAME COLUMN gstnumber TO gst_number;
  END IF;
