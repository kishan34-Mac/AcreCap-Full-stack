-- Recreate submissions table with correct snake_case column names
-- WARNING: This will drop existing data. Use only if necessary.

-- Drop the table if it exists
DROP TABLE IF EXISTS public.submissions CASCADE;

-- Create the submissions table with correct schema
